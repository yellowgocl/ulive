...
const API_BASE_URL = 'https://liveshop.zhibankeji.com' + root;
// const API_BASE_URL = 'http://10.2.0.78:8070' + root;
const API_CLOUD_URL = 'https://cloud.zhibankeji.com/';
const API_WMBS_URL = 'http://dev-hypoxia.zhibankeji.com'; // 微商城api
module.exports = {
    // LIVE_LIST: API_CLOUD_URL + 'api/v3/wechat/live/shop/app/wxa/business/live/info/list',
    WBMS_AUTH: API_WMBS_URL + '/auth/v1/authorize/application/',
    WBMS_FETCH_CATEGORY_LIST: API_WMBS_URL + '/content/v1/category/page',
    WBMS_FETCH_ARCHIVE_LIST: API_WMBS_URL + '/content/v1/archive/page',
    WBMS_ANALYTIC_ARCHIVE_DOWNLOD: API_WMBS_URL + '/content/v1/archive/rise/download/count',

    LIVE_LIST: API_BASE_URL + 'room/info/list',
    CLOUD_TOKEN: API_CLOUD_URL + 'api/v3/token',
    GET_CHAIN_JUNIOR: API_CLOUD_URL + 'account/v1/user/chain/junior/',
    GET_CHAIN_INVITE: API_CLOUD_URL + 'account/v1/user/chain/invite/',
    GET_USE_INFO: API_CLOUD_URL + 'account/v1/user/',
    GET_SHARE_QR: API_BASE_URL + 'user/wxa/share/code', //?scene=xxxxx&page=xxxxx
    POSI_BIND_INVITE: API_BASE_URL + 'user/bind/invite',
    APP_SHARE_CARD: 'https://dev-liveshop.zhibankeji.com/statics/share-card.png',

    ESHOP_USER_CENTER: API_BASE_URL + 'user/zib/center',
    ESHOP_USER_INFO: API_BASE_URL + 'user/zib',
    GetPhoneNumber: API_BASE_URL + 'auth/decrypt', // 获取用户手机号码
    ...
    BindUser: API_BASE_URL + 'user/bind', //第三方绑定
    IsBind: API_BASE_URL + 'user/bind/exists', // 判断是否有成功绑定过第三方账号
    ...
    BuyAdd: API_BASE_URL + 'buy/add', // 直接购买    a
