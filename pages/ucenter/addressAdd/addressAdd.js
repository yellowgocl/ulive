...
Page({
        ...
        success: (e) => {
          that.setData({
            address: {
              ...
              cityName: e.cityName,
              full_region: `${e.provinceName}${e.cityName}${e.countyName}`,
  ...
  saveAddress(){
    ...
    util.request(api.AddressSave, { 
      ...
      provinceName: address.province_name || address.provinceName,
      cityName: address.city_name || address.cityName,
      countyName: address.district_name || address.countyName,
